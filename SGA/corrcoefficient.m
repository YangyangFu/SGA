function [ r ] = corrcoefficient( x,y,corrModel)
%Calculate correlation coefficient
%   Two correlation coefficients are provided in this function:
...
%  -------------------------------------------------------------------
if nargin<3
    corrModel=lower('Spearman');
end

corrModel=lower(corrModel);

switch corrModel
    case 'spearman' % use matlab function corrcoeff
        r=corr(x,y,'type','Spearman');
        
    case 'productmoment'
        r=pm(x,y);
    otherwise
        error ('correlation coefficient model do not exist!')
